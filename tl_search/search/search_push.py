...
from tl_search.envs.tl_push import TLBlockedFetchPushEnv, atom_tl_ob2rob
...
def train_evaluate(
    ...
    env = TLBlockedFetchPushEnv(
        tl_spec, obs_props=obs_props, atom_pred_dict=atom_pred_dict, **env_config
    )
...
def evaluate_policy(
    model: TQC, env: TLBlockedFetchPushEnv, num_eval_episodes: int
